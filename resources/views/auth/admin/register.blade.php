...
@section('title', 'Admin Account Register - Blue Mail')
@section('description', 'The admin account registration page of Blue Mail.')
@section('keywords', 'Admin Account Register Blue Mail')
@section('content')
    <div class="grid grid-cols-1 p-3">
        <div
            ...
            <h1 class="px-2 text-2xl text-center">{{ __('site.admin_register_form') }}</h1>
            <div class="px-2 py-4">
